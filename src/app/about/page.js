	...
	return (
		<section className="grid grid-cols-2 gap-4 py-24 bg-white text-primary w-full px-16 m-0">
			<div className="flex flex-col gap-4">
				<h1 className='text-6xl font-black font-LogikBold'>OFFICIAL TOURNAMENT PLATFORM</h1>
