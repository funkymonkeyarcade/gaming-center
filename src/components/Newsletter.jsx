export default function Newsletter() {
	return(
		<section className="grid grid-cols-2 gap-4 py-24 bg-accent text-primary w-full px-16 m-0">
			<h1 className='text-6xl font-black font-LogikBold'>SIGN UP FOR OUR NEWSLETTER</h1>
